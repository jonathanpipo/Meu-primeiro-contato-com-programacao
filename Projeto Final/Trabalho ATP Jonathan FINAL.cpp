...
int main() {
	...
	int ano; // variavel do ano (case 2)
 	...
 	cout << "1 > Exibir o país que possui a maior taxa média de crescimento dos últimos trinta anos.\n"; // maior média 
 	...
 	cout << "4 > Exibir menor valor, maior valor, média, moda e variância de cada país.\n"; // menor valor, maior valor, média, moda, variância
 	cout << "5 > Exibir as ordenações de frequência dos três países. \n";
 	scanf ("%d", &escolha);
